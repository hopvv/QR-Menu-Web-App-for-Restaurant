...
The web app will automatically fetch from `http://localhost:5001/api/menu`.
...
3. **Network** tab: Watch API requests to `http://localhost:5001/api/menu`
...
curl "http://localhost:5001/api/menu?restaurantId=1"
```
